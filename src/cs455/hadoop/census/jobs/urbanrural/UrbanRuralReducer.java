...
public class UrbanRuralReducer extends Reducer<Text, LongTriple, Text, DoublePair> {
    @Override
    protected void reduce(Text state, Iterable<LongTriple> housesWithUrbanRural, Context context) throws IOException, InterruptedException {
        ...
        context.write(state, new DoublePair(urban * 100.0 / houses, rural * 100.0 / houses));
    }
}