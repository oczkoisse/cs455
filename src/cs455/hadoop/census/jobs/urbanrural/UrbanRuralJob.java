...
public class UrbanRuralJob {
    public static void main(String[] args) {
        try {
            ...
            // Current class.
            job.setJarByClass(UrbanRuralJob.class);
            // Mapper
            job.setMapperClass(UrbanRuralMapper.class);
            // Combiner.
            job.setCombinerClass(UrbanRuralCombiner.class);
            // Reducer
            job.setReducerClass(UrbanRuralReducer.class);
